  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="flex flex-col items-center py-10 px-4 animate-fade-in">
        <h1 className="text-4xl md:text-5xl lg:text-7xl text-center uppercase font-bold text-[#d3153b] bg-clip-text text-transparent">
          Cryptocurrency <br /> Payment Solutions
        </h1>

        <p className="text-base md:text-lg text-gray-700 max-w-lg md:max-w-2xl my-6 md:my-10 font-semibold text-center">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full px-4 md:px-10 lg:px-20 my-10 space-y-10 lg:space-y-0">
        ...
        <div className="w-full lg:w-1/2 flex flex-col space-y-4 animate-slide-in-left">
          <div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold uppercase bg-gradient-to-r text-[#d3153b]  text-transparent bg-clip-text leading-tight text-center lg:text-left">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-gray-700 text-md md:text-lg font-semibold leading-relaxed">
